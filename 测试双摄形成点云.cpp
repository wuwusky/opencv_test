...
bool myReadStringList(const string& filename, vector<string>& l)
{
	string filePath = "D:\\old-PC\\opencv3.1\\extra\\opencv_extra-master\\testdata\\cv\\structured_light\\data\\";
...
int main( int argc, char** argv )
{
  ...
  String images_file = "images.yml";
  String calib_file = "calibrationParameters.yml";
  params.width = 1920;
  params.height = 1280;
  ...
  bool ok = myReadStringList(images_file, imagelist);
  ...
  size_t numberOfPatternImages = graycode->getNumberOfPatternImages() - 2;
