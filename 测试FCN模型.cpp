...
static vector<cv::Vec3b> readColors(const string &filename = "..//fcn//pascal-classes.txt")
{
...
{
	String modelTxt = "..//fcn//fcn8s-heavy-pascal.prototxt";
	String modelBin = "..//fcn//fcn8s-heavy-pascal.caffemodel";
	String imageFile = "..//fcn//rgb.jpg";
