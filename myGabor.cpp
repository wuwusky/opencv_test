...
void myGabor::Init(Size ksize, double sigma, double gamma, int ktype)
{
...
Mat myGabor::getImagGaborKernel(Size ksize, double sigma, double theta, double nu, double gamma, int ktype)
{
...
//sigma一般为2*pi
Mat myGabor::getRealGaborKernel(Size ksize, double sigma, double theta, double nu, double gamma, int ktype)
{
	double	sigma_x = sigma;
	double	sigma_y = sigma / gamma;
	int		nstds = 3;
...
Mat myGabor::getMagnitude(Mat &real, Mat &imag)
{
	int ktype = real.type();
...
Mat myGabor::getPhase(Mat &real, Mat &imag)
{
	int ktype = real.type();
	int row = real.rows, col = real.cols;
	int i, j;
...
Mat myGabor::getFilterRealPart(Mat& src, Mat& real)
{
...
Mat myGabor::getFilterImagPart(Mat& src, Mat& imag)
{
...
void myGabor::getFilterRealImagPart(Mat& src, Mat& real, Mat& imag, Mat &outReal, Mat &outImag)
{
